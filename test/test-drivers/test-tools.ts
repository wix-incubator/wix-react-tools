...
export type StateAgnosticTestSuite<P> = (Comp: React.ComponentType<P>) => void;

export function testWithBothComponentTypes<P = {}>(sfc: React.SFC<P>, suite: StateAgnosticTestSuite<P>) {
    describe('SFC', () => {
        suite(sfc);
    });
